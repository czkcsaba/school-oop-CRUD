    ...
    public static function navbar() {
        ...
        <nav class="navbar">
            <ul class="nav-list">
                ...
                <li class="nav-button"><a href="/students"><button style="button" title="Tanulók">Tanulók</button></a></li>
                <li class="nav-button"><a href="/grades"><button style="button" title="Érdemjegyek">Érdemjegyek</button></a></li>
            </ul>
        </nav>
        HTML;
    }
